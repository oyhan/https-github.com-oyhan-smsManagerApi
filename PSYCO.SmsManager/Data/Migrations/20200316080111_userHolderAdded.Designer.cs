...
namespace PSYCO.SmsManager.Data.Migrations
{
    ...
    [Migration("20200316080111_userHolderAdded")]
    partial class userHolderAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575", ConcurrencyStamp = "7e082970-8550-4b95-94a1-af76e7720207", Name = "Admin", NormalizedName = "ADMIN" }
                    );
                });
            ...
            modelBuilder.Entity("PSYCO.SmsManager.DomainObjects.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575", AccessFailedCount = 0, ConcurrencyStamp = "e8fca675-3c1a-43d9-97ae-a90f477ecb07", Email = "admin@PooyanSystem.com", EmailConfirmed = true, IsActive = false, LockoutEnabled = false, NormalizedEmail = "ADMIN@POOYANSYSTEM.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAECvE5CPyfwm6QUd+no7RvjrCijTAu74f/fNPt/e0fq07P6MAdKLZVjBj+Rrq0PBkhw==", PhoneNumberConfirmed = false, SecurityStamp = "", TwoFactorEnabled = false, UserName = "Admin" }
                    );
                });
            ...
            modelBuilder.Entity("PSYCO.SmsManager.DomainObjects.ApplicationUser", b =>
                {
                    b.HasOne("PSYCO.SmsManager.DomainObjects.ApplicationUser", "Holder")
                        .WithMany()
